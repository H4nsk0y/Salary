  ...
  profile: [
    ...
    },
    {
      ...
      popover: {
        ...
        description: "Имя используется в табелях отдела, сменах и уведомлениях. Укажите его так, чтобы коллеги сразу вас узнали.",
        position: "right",
      },
    },
    {
    ...
    },
    {
      ...
      popover: {
        ...
        description: "Укажите официальный остаток, выберите даты и проверьте праздники, примерные отпускные и пересечения с отпусками коллег.",
        position: "left",
      },
    },
  ],
