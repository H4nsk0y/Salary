...
Клиентская политика пароля: минимум 8 символов, хотя бы одна буква и одна цифра. Настройки Supabase Auth должны соответствовать этим требованиям; пароль никогда не сохраняется и не журналируется приложением.
